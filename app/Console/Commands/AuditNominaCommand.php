...
class AuditNominaCommand extends Command
{
    ...
    // Targets = valores de control Junio 2026. Actualizar por período según tabla oficial.
    // IMSS patronal (archivo IMSS) se audita con reportes:audit-imss — no está en esta tabla.
    // Rows marcadas "(no incluido en total)" son informativas: deducción al trabajador, no gasto empresa.
    private const CONCEPTOS = [
        ['Nómina',                                        'NOI',        ['P001'], ['D111' => 1, 'D137' => -1], null, null, 1_065_400.90],
        ['Comisiones',                                    'NOI',        ['P002', 'P119'], [], null, null, 718_658.53],
        ['Vacaciones',                                    'NOI',        ['P009', 'P027', 'P113'], [], null, null, 23_281.96],
        ['Prima vacacional',                              'NOI',        ['P010'], [], null, null, 4_420.48],
        ['Bonos',                                         'NOI',        ['P108', 'P109', 'P110', 'P112', 'P114', 'P115', 'P120', 'P123', 'P124'], [], null, null, 306_417.45],
        ['Bonos Aceleradores',                            'NOI',        ['P118'], [], null, null, 0.0],
        ['Descuentos Infonavit (no incluido en total)',   'NOI',        [], ['D092' => 1, 'D094' => 1, 'D105' => 1, 'D129' => 1], null, null, 32_793.76],
        ['Descuento Servicios Moto (no incluido en total)', 'NOI',      [], ['D113' => 1], null, null, 4_000.84],
        ['Financiamiento Celular (no incluido en total)', 'NOI',        [], ['D125' => 1], null, null, 0.0],
        ['Descuento de uniformes (no incluido en total)', 'NOI',        [], ['D112' => 1], null, null, 0.0],
        ['Descuento extravío tarjeta (no incluido en total)', 'NOI',    [], ['D117' => 1], null, null, 0.0],
        ['Descuentos Tienda Mr Lana (no incluido en total)', 'NOI',     [], ['D122' => 1, 'D126' => 1, 'D127' => 1], null, null, 0.0],
        ['Descuento Servicios Automóvil (no incluido en total)', 'NOI', [], ['D114' => 1], null, null, 0.0],
        ['Descuento faltante en caja (no incluido en total)', 'NOI',    [], ['D118' => 1], null, null, 0.0],
        ['Anticipo de nómina (no incluido en total)',     'NOI',        [], ['D003' => 1], null, null, 0.0],
        ['Pensión Alimenticia (no incluido en total)',    'NOI',        [], ['D010' => 1], null, null, 0.0],
        ['Descuentos FONACOT (no incluido en total)',     'LENDUS',     [], [], 'Nómina y Capital Humano', ['FONACOT'], 6_933.16],
        ['Finiquito',                                     'LENDUS',     [], [], 'Nómina y Capital Humano', ['FINIQUITO'], 64_987.59],
        ['Gastos médicos',                                'LENDUS',     [], [], 'Nómina y Capital Humano', ['MEDICO', 'MÉDICO', 'MEDIC'], 4_140.00],
        ['Gasolina',                                      'ERP',        [], [], 'Gasolina', null, 154_800.00],
        ['Financiamiento De Motos',                       'LENDUS_XLS', [], [], 'Nómina y Capital Humano', ['FINANCIAMIENTO MOTO', 'PAGO FINANCIAMIENTO MOTO'], 164_964.75],
        ['Cascos',                                        'LENDUS_XLS', [], [], null, ['CASCOS', 'COMPRA DE CASCOS', 'CASCO'], 8_974.00],
        ['Formatería',                                    'GASTO',      [], [], null, ['FORMATER'], 1_500.00],
