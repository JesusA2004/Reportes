...
<title>Error al generar reporte — {{ $period->label }}</title>
</head>
    ...
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 4px 32px rgba(0,0,0,.08);">
      ...
      <tr>
        <td style="background:#0f172a;padding:28px 36px;">
          ...
          <h1 style="margin:0;color:#ffffff;font-size:22px;font-weight:900;line-height:1.3;">Error al generar reporte</h1>
        </td>
      </tr>
      ...
      <tr>
        <td style="background:#fef2f2;padding:14px 36px;border-bottom:1px solid #fecaca;">
          <p style="margin:0;color:#dc2626;font-size:13px;font-weight:700;">✗ &nbsp;La generación del reporte terminó con error</p>
        </td>
      </tr>
      ...
      <tr>
        <td style="padding:36px 36px 28px;">
          ...
          <p style="margin:0 0 28px;color:#334155;font-size:15px;line-height:1.7;">
            No se pudo generar el reporte del periodo <strong style="color:#0f172a;">{{ $period->label }}</strong>.
            Revisa las fuentes, incidencias o configuración del reporte desde Histórico General.
          </p>
