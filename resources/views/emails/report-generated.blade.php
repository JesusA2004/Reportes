    ...
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 4px 32px rgba(0,0,0,.08);">
      ...
      <tr>
        <td style="background:#dcfce7;padding:14px 36px;border-bottom:1px solid #bbf7d0;">
          <p style="margin:0;color:#15803d;font-size:13px;font-weight:700;">✓ &nbsp;Excel y PDF generados correctamente</p>
        </td>
      </tr>
        ...
        <td style="padding:36px 36px 28px;">
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;margin-bottom:28px;">
            ...
            <tr style="border-bottom:1px solid #e2e8f0;">
              ...
              <td style="padding:12px 18px;font-size:13px;color:#0f172a;">{{ $run->finished_at?->format('d/m/Y H:i') ?? now()->format('d/m/Y H:i') }}</td>
            </tr>
            <tr>
              <td style="padding:12px 18px;font-size:13px;color:#64748b;font-weight:600;">Archivos</td>
              <td style="padding:12px 18px;font-size:13px;color:#15803d;font-weight:700;">Excel y PDF disponibles</td>
            </tr>
          </table>
          ...
          <table role="presentation" cellpadding="0" cellspacing="0">
            <tr>
              <td style="background:#4f46e5;border-radius:12px;padding:14px 28px;margin-right:12px;">
                <a href="{{ $downloadUrl }}" style="color:#ffffff;font-size:14px;font-weight:700;text-decoration:none;display:inline-block;">
                  Ver reporte →
                </a>
              </td>
            </tr>
          ...
          <p style="margin:20px 0 0;color:#94a3b8;font-size:13px;line-height:1.6;">
            También puedes ir a <a href="{{ route('reportes-mensuales.index') }}" style="color:#4f46e5;text-decoration:none;font-weight:600;">Reportes mensuales</a> para consultar el historial completo.
          </p>
        </td>
      </tr>
