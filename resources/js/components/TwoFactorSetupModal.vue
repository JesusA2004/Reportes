...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'La autenticación en dos pasos ya está activada. Escanea el código QR o ingresa la clave de configuración en tu aplicación autenticadora.',
            buttonText: 'Cerrar',
        };
    }
    ...
    return {
        ...
        description:
            'Para finalizar la activación de la autenticación en dos pasos, escanea el código QR o ingresa la clave de configuración en tu aplicación autenticadora',
        buttonText: 'Continuar',
    };
});
