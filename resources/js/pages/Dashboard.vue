...
const quickLinks = [
    ...
    { label: 'Asignación de sucursales', description: 'Asigna empleados a sucursales y resuelve pendientes.', href: '/asignaciones-empleado-sucursal', icon: Users, color: 'bg-sky-500' },
...
<template>
    ...
    <div class="space-y-8 p-4 sm:p-6 lg:p-8">
        ...
        <!-- Hero -->
        <section class="relative overflow-hidden rounded-[2rem] bg-slate-950 p-6 text-white shadow-2xl shadow-slate-200 sm:p-8">
            <div class="pointer-events-none absolute -top-24 -right-24 size-72 rounded-full bg-indigo-500/30 blur-3xl"></div>
            <div class="pointer-events-none absolute -bottom-28 -left-16 size-72 rounded-full bg-emerald-500/10 blur-3xl"></div>
            <div class="relative flex items-center gap-3">
                <div class="flex size-10 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 to-indigo-700 shadow-lg shadow-indigo-900/40">
            ...
            <h1 class="relative mt-4 text-3xl font-black tracking-tight sm:text-4xl">Panel de control</h1>
            <p class="relative mt-2 max-w-2xl text-sm leading-6 text-slate-300">
            ...
            <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="font-black text-slate-950">Asignación de sucursales</p>
                    </div>
                    <p class="mt-3 text-sm leading-6 text-slate-500">
